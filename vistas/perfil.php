...
<body>
    <header class="py-3">
        <div class="container">
            ...
            <nav>
                <ul class="nav">
                    <li class="nav-item"><a class="nav-link" href="/VirtualWalletSpending/dashboard">Volver al Dashboard</a></li>
    ...
    <main class="container my-4">
        <section class="mb-4">
            ...
            <div class="card">
                <div class="card-body">
                    <form id="cambioNombre" action="/VirtualWalletSpending/cambioNombres" method="post">
                        <div class="mb-3">
            ...
            <div class="card mt-4">
                <div class="card-body">
                    <form id="cambioContrasena" action="/VirtualWalletSpending/cambioContrasena" method="post">
                    <div class="mb-3">
    ...
    <script src="\VirtualWalletSpending\js\perfil.js"></script>
